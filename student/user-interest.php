            ...
            <div class="view__container interest__container">
                ...
                if (mysqli_num_rows($r2) > 0) {
                    while ($row2 = mysqli_fetch_array($r2)) { ?>
                        ...
                        <div class="interest__btn">
                            <span class="interest__name">
                                <?php echo $row2['domain_name']; ?>
                            </span>
                            <a onclick="return confirm('Are you sure you want to delete this item?');" href="user-interest-delete.php?int_id=<?php echo $row2['interest_id']; ?>" class="interest__remove">
