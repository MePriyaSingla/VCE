            ...
            <div class="login-container-2">
                <form action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']) ?>" method="post"
                    ...
                    <div class="input">
                        ...
                        <input type="text" value="<?php echo $srow['course_name']; ?>" class="input__box" name="c_name"
                            required>
                    </div>
                    <div class="input">
                        <label class="label__text">Platform Name:</label>
                        <input type="text" value="<?php echo $srow['platform_name']; ?>" class="input__box"
                            name="p_name" required>
                    </div>
                    <div class="input">
                        <label class="label__text">Tutor Name:</label>
                        <input type="text" value="<?php echo $srow['tutor_name']; ?>" class="input__box" name="t_name"
                            required>
                    </div>
                    <div class="input">
                    ...
                    <div class="input">
                        ...
                        <input type="text" value="<?php echo $srow['course_link']; ?>" class="input__box" name="c_link"
                            required>
                    </div>
                    <div class="input">
                        <label class="label__text">Course Duration:</label>
                        <input type="text" value="<?php echo $srow['course_duration']; ?>" class="input__box"
                ...
                if (isset($_POST['edit_course'])) {
                    ...
                    $sin = "UPDATE `course_table` SET `course_field` = '$fieldName',`course_domain` = '$domainName',`course_name` = '$courseName',`platform_name` = '$platformName',`tutor_name` = '$tutorName',`course_level` = '$courseLevel',`course_link` = '$courseLink',`course_duration` = '$courseDuration' WHERE `course_id` = '" . $_GET['cid'] . "'";
