                    ...
                    ?>
                            ...
                            <div class="course__card">
                                ...
                                <div class="course__options">
                                    <a href="edit-user-achievement.php?aid=<?php echo $rowQ['achievement_id']; ?>" class="edit-btn">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <a onclick="return confirm('Are you sure you want to delete this item?');" href="remove-user-achievement.php?aid=<?php echo $rowQ['achievement_id']; ?>" class="remove-btn">
