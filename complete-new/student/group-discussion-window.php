    ...
    <div class="container">
        ...
        <main class="main__content">
            ...
            <div class="user__chat-container">
                                ...
                                if (mysqli_num_rows($queryU) > 0) {
                                    while ($rowU = mysqli_fetch_array($queryU)) { ?>
                                        <p class="user__chat-msg-recieve">
                                            <a class="group__chat-user-link" href="connect-profile.php?profile=<?php echo $rowU['user_id'] ?>&fname=<?php echo $rowU['user_firstname']; ?>&lname=<?php echo $rowU['user_lastname']; ?>">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']) ?>" method="post" class="user__chat-typing">
                    <input class="user_chat-input" type="text" placeholder="Type message..." name="u_msg" autocomplete="off">
