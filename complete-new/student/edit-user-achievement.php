                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" class="login__form">
                    ...
                    ?>
                            <div class="input">
                                ...
                                <input type="text" value="<?php echo $erow['achievement_course']; ?>" class="input__box" name="c_name" required>
                            </div>
                            <div class="input">
                                <label class="label__text">Platform or Institute:</label>
                                <input type="text" value="<?php echo $erow['achievement_platform']; ?>" class="input__box" name="p_name" required>
                            </div>
                            <div class="input">
                                <label class="label__text">Tutor Name:</label>
                                <input type="text" value="<?php echo $erow['achievement_tutor']; ?>" class="input__box" name="t_name" required>
                            </div>
                            <div class="input">
                                <label class="label__text">Course Duration:</label>
                                <input type="text" value="<?php echo $erow['achievement_courseduration']; ?>" class="input__box" name="c_duration" required>
                            </div>
                            <div class="input">
                                <label class="label__text">Completed on:</label>
                                <input type="date" value="<?php echo $erow['achievement_completedon']; ?>" class="input__box" name="c_completedon" required>
                            </div>
                            <div class="input">
                                <label class="label__text">Course Link (if any):</label>
                                <input type="text" value="<?php echo $erow['achievement_courselink']; ?>" class="input__box" name="c_link">
                            </div>
                    <?php
                        }
                    } ?>
